...
public class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    public var menuWidth :CGFloat =  width {
        didSet {
    ...
    private var needUpdateApperance : Bool = true
    ...
    private func setupMenuView() {
        ...
        updateFrame()
        //blackcolor with alpha value
        let blackColor = UIColor.blackColor() // 1.0 alpha
        let blackColorWithAlpha = UIColor(red: 0, green: 0, blue: 0, alpha: 0.8)//blackColor.colorWithAlphaComponent(1) // 0.7 alpha
